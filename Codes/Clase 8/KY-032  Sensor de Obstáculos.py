...
MQTT_TOPIC = "blhd/sensores/obstaculo"  # Tema MQTT para el sensor KY-032
...
# 🔗 Configuración de pines del sensor KY-032
...
# 🔗 Configuración MQTT
client = MQTTClient("ESP32_ObstacleSensor", MQTT_SERVER)
conectar_mqtt()
...
try:
    while True:
        ...
        if sensor_value == 0:
            ...
            message = "No se detectan obstáculos"
